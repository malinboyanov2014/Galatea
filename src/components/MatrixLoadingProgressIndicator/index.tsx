...
const CHARS =
  "ABCDEFGHIJKLMNOPQRSTUVWXYZアイウエオカキクケコサシスセソタチツテトナニヌネノ0123456789!@#$%^&*<>";
const CHAR_W = 14;
const CHAR_H = 18;
...
export default function MatrixLoadingProgressIndicator({
  width: widthProp,
  height: heightProp,
  progress,
  duration,
      ...
      style={[
        {
          ...
          flexDirection: "row",
          ...(isBorder
            ? { borderRadius: 8, borderWidth: 1, borderColor: outline }
            : {}),
        },
